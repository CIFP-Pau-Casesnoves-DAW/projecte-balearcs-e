...
$router->group(['prefix' => 'illes', 'middleware' => ControlaAdministrador::class], function () use ($router) {
    $router->get('', [IllaController::class, 'index']);
    $router->get('{id}', [IllaController::class, 'show']);
    $router->post('', [IllaController::class, 'store']);
    $router->put('{id}', [IllaController::class, 'update']);
    $router->delete('{id}', [IllaController::class, 'destroy']);
});
