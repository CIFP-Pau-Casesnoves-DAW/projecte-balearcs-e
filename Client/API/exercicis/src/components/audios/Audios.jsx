...
export default function Audios(props) {
    ...
    const [columnes, setColumnes] = useState([
        ...
        { field: 'audio', headerName: 'Audio', width: 200, sortable: true, filter: true },
