...
export default function Fotos(props) {
    ...
    const [columnes, setColumnes] = useState([
        ...
        { field: 'foto', headerName: 'Foto', width: 200, sortable: true, filter: true },
        { field: 'punt_interes_id', headerName: 'Punt d\'interès', width: 200, sortable: true, filter: true },
        { field: 'espai_id', headerName: 'Espai', width: 200, sortable: true, filter: true },
        { field: 'comentari', headerName: 'Comentari', width: 200, sortable: true, filter: true },
