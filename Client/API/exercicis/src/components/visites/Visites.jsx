...
export default function Visites(props) {
    ...
    const [columnes, setColumnes] = useState([
        ...
        { field: 'data_inici', headerName: 'Data d\'inici', width: 200, sortable: true, filter: true },
        { field: 'data_fi', headerName: 'Data de fi', width: 200, sortable: true, filter: true },
        { field: 'horari', headerName: 'Horari', width: 200, sortable: true, filter: true },
    ]);
