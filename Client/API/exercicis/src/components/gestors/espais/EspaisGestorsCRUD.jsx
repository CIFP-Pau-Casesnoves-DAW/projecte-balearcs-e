...
import FormulariAfegirVisites from '../espais/FormulariAfegirVisites';
import VisitesEspaisGestors from '../espais/VisitesEspaisGestors';
...
export default function EspaisGestorCRUD(props){
    ...
    const [mostraFormulariVisites, setMostraFormulariVisites] = useState(false);
    ...
    return (
        <div>
            ...
            <Row md={9}>
                ...
                <Col style={{textAlign:"right"}}>
                    <Button
                        ...
                        type="button"
                        onClick={() => {
                            setMostraFormulariVisites(true)
                        }}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-database-fill-add" viewBox="0 0 16 16">
                            <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0M8 1c-1.573 0-3.022.289-4.096.777C2.875 2.245 2 2.993 2 4s.875 1.755 1.904 2.223C4.978 6.711 6.427 7 8 7s3.022-.289 4.096-.777C13.125 5.755 14 5.007 14 4s-.875-1.755-1.904-2.223C11.022 1.289 9.573 1 8 1"/>
            ...
            {mostraFormulariVisites && (
                <FormulariAfegirVisites
                    api_token={token}
                    espai_id={id}
                    onCancel={() => setMostraFormulariVisites(false)}
                />
            )}
            <hr />
            <VisitesEspaisGestors api_api_token={token} espai_id={id}token/>  
            <hr />
